...
public class BIMCalculatorAdvancedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bimcalculator_advanced);


        intent = getIntent();
        bmicategory = (TextView) findViewById(R.id.bmicategory_advanced);
        gender = (TextView) findViewById(R.id.genderdisplay);
        background = (RelativeLayout) findViewById(R.id.contentLayout);
        imageview = (ImageView) findViewById(R.id.imageview);
        recalculate = (Button) findViewById(R.id.recalculatebmi_advanced);


        height = intent.getStringExtra("height_advanced");
        weight = intent.getStringExtra("weight_advanced");
        ...
        gender.setText(intent.getStringExtra("gender_advanced"));



        recalculate = (Button) findViewById(R.id.recalculatebmi_advanced);
        backbtn = (Button) findViewById(R.id.recalculatebmi_back_advanced);

        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(BIMCalculatorAdvancedActivity.this, AdvancedProfileActivity.class);
